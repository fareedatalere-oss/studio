        ...
        <div className="flex flex-col h-screen">
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>This will permanently delete this draft.</AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
            ...
            <main className="flex-1 p-4 overflow-y-auto">
                 <div
                    ...
                    dir="ltr"
                    className="h-full w-full p-4 max-w-none focus:outline-none text-foreground bg-background text-left prose dark:prose-invert"
                />
            </main>
