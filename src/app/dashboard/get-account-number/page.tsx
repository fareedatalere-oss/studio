...
export default function GetAccountNumberPage() {
  ...
  const [generatedAccount, setGeneratedAccount] = useState({ number: '', bank: '' });
    ...
    try {
      ...
      if (result.success && result.data.account_number) {
        ...
        toast({
            ...
            description: result.message || 'We could not generate your account number. Please check your details and try again.',
        });
        setStep('form');
      }
    } catch (error: any) {
        ...
        <div className="container py-8">
            <Card className="w-full max-w-lg mx-auto text-center">
                <CardHeader>
                    ...
                    <CardDescription>Please wait, we're creating your new account...</CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <div className="container py-8">
            <Card className="w-full max-w-lg mx-auto text-center">
                <CardHeader>
                    ...
                    <CardDescription>Your new account details are below. This has been permanently saved to your profile.</CardDescription>
                </CardHeader>
