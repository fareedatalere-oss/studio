            ...
            <header className="p-4 pt-12 max-w-xl mx-auto w-full flex flex-col items-center">
                ...
                <Tabs defaultValue="recent" className="flex flex-col w-full items-center">
                    <TabsList className="flex items-center gap-1 bg-muted/50 h-6 p-1 rounded-full mb-6 justify-center w-fit px-1 border">
                        <TabsTrigger value="recent" className="text-[7px] font-black rounded-full px-3 h-4 data-[state=active]:bg-primary data-[state=active]:text-white">Recent</TabsTrigger>
                        <TabsTrigger value="all" className="text-[7px] font-black rounded-full px-3 h-4 data-[state=active]:bg-primary data-[state=active]:text-white">All</TabsTrigger>
                    </TabsList>
