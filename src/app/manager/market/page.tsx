...
export default function ManagerMarketPage() {
   ...
   useEffect(() => {
    const hasBypass = sessionStorage.getItem('manager-market-bypass') === 'true';
    if (!hasBypass) {
      router.replace('/manager/market/bypass');
    } else {
        setLoading(false);
    }
  }, [router]);
  ...
  return (
    <div className="container py-8">
      <h1 className="text-2xl font-bold mb-4">Market Management</h1>
